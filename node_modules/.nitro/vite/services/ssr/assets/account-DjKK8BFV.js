import { d as fmt, f as fmtDate, h as useDemo, l as PLANS } from "./cinematic-CKTwKQYq.js";
import { n as PageHeader, t as AppShell } from "./app-shell-D8hIeRxF.js";
import { a as CardTitle, i as CardHeader, n as CardContent, r as CardDescription, t as Card } from "./card-D9j1H0wW.js";
import { useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Crown, LogOut, Phone, TrendingUp, User, Wallet } from "lucide-react";
...
function AccountPage() {
	...
	return /* @__PURE__ */ jsxs(AppShell, { children: [
		...
		/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(User, { className: "h-10 w-10 text-gold" })
				}), /* @__PURE__ */ jsxs("div", {
					className: "flex-1",
					children: [
						/* @__PURE__ */ jsx("h2", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsx(Crown, { className: "h-3.5 w-3.5" }), plan?.name ?? "بدون باقة"]
							})]
						})
					]
				})]
			...
			children: stats.map((stat) => {
				...
				return /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						] }), /* @__PURE__ */ jsx(Icon, { className: `h-8 w-8 ${stat.color} opacity-60` })]
					})
				}, stat.label);
			})
		}),
		/* @__PURE__ */ jsxs(Card, {
			...
			children: [/* @__PURE__ */ jsxs(CardHeader, { children: [/* @__PURE__ */ jsx(CardTitle, {
			...
			}), /* @__PURE__ */ jsx(CardDescription, { children: "بيانات حسابك الشخصية" })] }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
						...
						children: [/* @__PURE__ */ jsx(User, { className: "h-4 w-4 text-muted-foreground" }), /* @__PURE__ */ jsx("span", { children: user.fullName })]
					})] }),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
						className: "block text-sm font-medium text-muted-foreground mb-2",
						children: "رقم الهاتف"
						...
						className: "glass rounded-lg px-4 py-3 border border-border/50 text-ivory flex items-center gap-3",
						children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 text-muted-foreground" }), /* @__PURE__ */ jsx("span", {
							dir: "ltr",
							children: user.phone
						})]
					})] }),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
						...
						className: "glass rounded-lg px-4 py-3 border border-border/50 text-ivory flex items-center gap-3",
						children: [/* @__PURE__ */ jsx(Crown, { className: "h-4 w-4 text-gold" }), /* @__PURE__ */ jsx("span", { children: plan?.name ?? "بدون باقة" })]
					})] }),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
						className: "block text-sm font-medium text-muted-foreground mb-2",
						children: "الحالة"
						...
						className: "glass rounded-lg px-4 py-3 border border-border/50 text-ivory flex items-center gap-3",
						children: [/* @__PURE__ */ jsx("span", { className: `h-2 w-2 rounded-full ${user.status === "active" ? "bg-success" : "bg-destructive"}` }), /* @__PURE__ */ jsx("span", { children: user.status === "active" ? "نشط" : "موقوف" })]
					})] })
				]
			}) })]
		}),
		/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx(LogOut, { className: "h-5 w-5" }), "تسجيل الخروج"]
			})
		})
	] });
}
