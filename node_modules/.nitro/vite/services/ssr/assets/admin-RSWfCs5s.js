import { a as Reveal, d as fmt, f as fmtDate, h as useDemo, l as PLANS, m as statusLabel, n as Counter } from "./cinematic-CKTwKQYq.js";
import { n as PageHeader, t as AppShell } from "./app-shell-D8hIeRxF.js";
import { t as StatusPill } from "./status-pill-DIyypxod.js";
...
function Admin() {
	...
	const filteredUsers = useMemo(() => users.filter((u) => (u.fullName + u.phone).includes(q.trim())), [users, q]);
	const filteredRequests = useMemo(() => requests.filter((r) => (filter === "all" || r.status === filter) && (r.userName + r.method).includes(q.trim())), [
		requests,
		filter,
		q
	]);
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: /* @__PURE__ */ jsx(Counter, { to: s.value })
						}), /* @__PURE__ */ jsx("span", {
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Search, { className: "h-4 w-4 shrink-0 text-gold" }), /* @__PURE__ */ jsx("input", {
					value: q,
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: notifications.slice(0, 5).map((n) => /* @__PURE__ */ jsxs("li", {
		...
		tab === "users" && /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("h2", {
				...
				children: [/* @__PURE__ */ jsxs("table", {
					...
					}) }), /* @__PURE__ */ jsx("tbody", { children: filteredUsers.map((u) => /* @__PURE__ */ jsxs("tr", {
		...
		tab === "requests" && /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
			className: "mt-5 rounded-3xl glass p-7",
			children: [
				/* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsx("ul", {
					...
					children: filteredRequests.map((r) => /* @__PURE__ */ jsxs("li", {
				...
				filteredRequests.length === 0 && /* @__PURE__ */ jsx("p", {
					className: "py-10 text-center text-sm text-muted-foreground",
					children: "لا توجد طلبات مطابقة."
				})
			]
		}) }),
		tab === "logs" && /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
			className: "mt-5 rounded-3xl glass p-7",
			children: [/* @__PURE__ */ jsx("h2", {
				className: "font-display text-lg text-ivory",
				children: "سجل النشاط"
				...
				children: logs.map((l) => /* @__PURE__ */ jsxs("li", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 h-2 w-2 shrink-0 rounded-full bg-gold" }), /* @__PURE__ */ jsxs("span", {
						className: "min-w-0",
						children: [/* @__PURE__ */ jsx("span", {
...
var SplitComponent = () => /* @__PURE__ */ jsx(AppShell, { children: /* @__PURE__ */ jsx(Admin, {}) });
//#endregion
