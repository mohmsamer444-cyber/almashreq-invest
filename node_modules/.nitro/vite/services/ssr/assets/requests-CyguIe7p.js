import { a as Reveal, c as PAYMENT_METHODS, d as fmt, f as fmtDate, h as useDemo, m as statusLabel } from "./cinematic-CeWt9z_f.js";
import { n as PageHeader, t as AppShell } from "./app-shell-Dw57mmAJ.js";
import { t as StatusPill } from "./status-pill-DOTrKUYY.js";
...
import { z } from "zod";
//#region src/routes/requests.tsx?tsr-split=component
var schema = z.object({
	amount: z.coerce.number().min(500, "أقل مبلغ هو ٥٠٠ ج.م").max(1e6, "أقصى مبلغ هو ١٬٠٠٠٬٠٠٠ ج.م"),
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Link, {
				...
				})] }), /* @__PURE__ */ jsx(ArrowLeft, { className: "w-5 h-5 text-gold opacity-60 group-hover:opacity-100" })]
			}), /* @__PURE__ */ jsxs(Link, {
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("form", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: ["deposit", "withdraw"].map((k) => /* @__PURE__ */ jsx("button", {
							type: "button",
							onClick: () => setKind(k),
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: PAYMENT_METHODS.map((m) => /* @__PURE__ */ jsxs("button", {
									type: "button",
						...
						children: [
							...
							/* @__PURE__ */ jsxs("label", {
								...
								children: [
									...
									errors["note"] && /* @__PURE__ */ jsxs("span", {
							...
							/* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsx("button", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("span", {
											...
											children: receipt ? "✓" : /* @__PURE__ */ jsx(FileUp, { className: "h-6 w-6" })
										}), /* @__PURE__ */ jsxs("div", {
								...
								errors["receipt"] && /* @__PURE__ */ jsxs("span", {
					...
					/* @__PURE__ */ jsxs("button", {
						...
						children: [busy && /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "إرسال الطلب"]
					})
				]
			}) }), /* @__PURE__ */ jsxs("div", {
				className: "space-y-5",
				children: [/* @__PURE__ */ jsx(Reveal, {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: TIMELINE.map((s, i) => /* @__PURE__ */ jsxs("li", {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: [i === 0 ? /* @__PURE__ */ jsx(Clock, { className: "h-4 w-4" }) : i === 1 ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }), i < TIMELINE.length - 1 && /* @__PURE__ */ jsx("span", { className: "absolute top-9 h-6 w-px bg-border" })]
								}), /* @__PURE__ */ jsxs("span", {
									className: "min-w-0",
									children: [/* @__PURE__ */ jsx("span", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: requests.map((r) => /* @__PURE__ */ jsxs("li", {
...
var SplitComponent = () => /* @__PURE__ */ jsx(AppShell, { children: /* @__PURE__ */ jsx(Requests, {}) });
//#endregion
