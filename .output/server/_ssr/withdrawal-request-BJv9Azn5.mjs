...
import { A as CircleCheckBig, N as Check, O as Clock, z as ArrowRight } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/withdrawal-request-BJv9Azn5.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormField, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									"الرصيد المتاح: ",
									user.balance.toLocaleString("ar-EG"),
									" ريال"
								]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: withdrawalMethods.map((method) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => setFormData({
										...formData,
										withdrawalMethod: method.id
									}),
									className: `p-3 rounded-lg border transition-all text-sm font-medium ${formData.withdrawalMethod === method.id ? "bg-gold/20 border-gold/40 text-gold" : "border-border/50 text-muted-foreground hover:border-gold/30 hover:bg-gold/5"}`,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
					...
					children: withdrawalHistory.map((withdrawal) => {
						const StatusIcon = withdrawal.status === "completed" ? CircleCheckBig : Clock;
						const statusColor = withdrawal.status === "completed" ? "text-success" : "text-warning";
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [withdrawal.amount, " ريال"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-xs text-muted-foreground",
								children: withdrawal.method
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-right",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusIcon, { className: `w-4 h-4 ${statusColor}` }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted-foreground mt-1",
									children: withdrawal.statusAr
								})]
							})]
						}, withdrawal.id);
					})
